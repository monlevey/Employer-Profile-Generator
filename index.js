...
function addMember() {
    ...
    {
        type: "list",
        message: "Select that team member's role",
        choices: [
            "Manager",
            "Engineer",
            "Intern",
...
function addHtml(member) {
    return new Promise(function(resolve, reject) {
        ...
        if (role === "Engineer") {
            ...
            <h5 class="card-header bg-success text-white">${name}<br /><br />Engineer</h5>
            ...
            data = `<div class="col-6">
            <div class="card mx-auto mb-3" style="width: 18rem">
            <h5 class="card-header bg-warning text-dark">${name}<br /><br />Intern</h5>
            <ul class="list-group list-group-flush">
                <li class="list-group-item">ID: ${id}</li>
                <li class="list-group-item">Email: <a href="mailto:${email}">${email}</a></li>
            ...
            <ul class="list-group list-group-flush">
                ...
                data = `<div class="col-6">
                <div class="card mx-auto mb-3" style="width: 18rem">
                <h5 class="card-header bg-danger">${name}<br /><br />${role}</h5>
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">ID: ${id}</li>
                    <li class="list-group-item">Email: <a href="mailto:${email}">${email}</a></li>
